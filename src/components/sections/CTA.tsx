...
export default function CTA() {
  return (
    <section className="py-12 sm:py-24 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto glass p-8 sm:p-12 md:p-20 rounded-2xl sm:rounded-[2rem] text-center relative overflow-hidden gold-glow border-primary/20">
        ...
        <h2 className="text-2xl sm:text-4xl md:text-5xl font-headline font-bold mb-6 sm:mb-8 relative z-10">
          Build Your AI Infrastructure <br /> With Visoma
        </h2>
        <p className="text-base sm:text-xl text-muted-foreground mb-8 sm:mb-12 max-w-2xl mx-auto relative z-10">
